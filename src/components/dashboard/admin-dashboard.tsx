    ...
    <div className="space-y-6">
      <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
        <div>
          ...
          <p className="text-muted-foreground">Welcome back! Here's an overview of your assessment platform.</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
        <Card className="md:col-span-2 lg:col-span-4">
          <CardHeader>
            ...
            <CardDescription>Test completion and performance metrics over time</CardDescription>
          </CardHeader>
        ...
        <Card className="md:col-span-2 lg:col-span-3">
          <CardHeader>
            ...
            <CardDescription>Your recently created assessment tests</CardDescription>
          </CardHeader>
          <CardContent>
            <RecentTests />
          </CardContent>
